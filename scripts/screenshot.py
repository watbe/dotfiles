...
if __name__ == "__main__":
	...
	subprocess.call("echo \"http://qwk.cc/%s.png\" | xclip" % randomID, shell=True)
	subprocess.call("echo 'naughty.notify({title = \"Screenshot Uploaded!\", text = \"qwk.cc/%s.png copied to clipboard\", timeout = 5})' | awesome-client -" % randomID, shell=True)
	sys.exit(0);
